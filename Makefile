...
OFILES = gba.o font.o logic.o graphics.o main.o images/startgame.o \
		images/f_box.o images/tile_0.o images/tile_1.o images/f_logo.o \
		images/f_score_box.o images/title_logo.o images/num_0.o images/num_1.o \
		images/num_2.o images/num_3.o images/num_4.o images/num_5.o images/num_6.o \
		images/num_7.o images/num_8.o images/num_9.o images/tile_2.o images/tile_3.o \
		images/tile_4.o images/tile_5.o images/tile_6.o images/tile_7.o images/tile_8.o \
		images/tile_9.o images/tile_10.o images/tile_11.o \
		images/f_win_box.o images/f_gameover_box.o
